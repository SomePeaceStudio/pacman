...
client_gui: client/main.c client/login.h mkdir
	$(CC) `pkg-config --cflags gtk+-3.0` client/main.c client/login.c shared/shared.c -o $(BIN_CLIENT_GUI) `pkg-config --libs gtk+-3.0`
